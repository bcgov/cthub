...
# Podman Instructions
- Make sure Podman Desktop (https://podman-desktop.io/) is installed and running
...
- To access postgres:
  ...
  - Execute the following:
    ...
    - Some notes about the structure of the command
      - podman compose exec - this is your standard command to execute something within the context of the docker-compose yml file
...
- To access the backend: (to do migrations and other stuff with the backend)
  ...
  podman compose -f docker-compose-local-dev.yml up
