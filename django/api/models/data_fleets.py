...
class DataFleets(Auditable):
    ...
    rebate_value = models.CharField(blank=True, null=True, max_length=100, unique=False)
    ...
    city = models.CharField(blank=True, null=True, max_length=250, unique=False)

    postal_code = models.CharField(blank=True, null=True, max_length=100, unique=False)
    ...
    deadline = models.CharField(blank=True, null=True, max_length=250, unique=False)
