  ...
  if (phase === "dev") {
    ...
    objects = objects.concat(
      oc.processDeploymentTemplate(
        `${templatesLocalBaseUrl}/templates/unittest/zeva-postgresql-init.yaml`,
        {
          param: {
    ...
    objects = objects.concat(
      oc.processDeploymentTemplate(
        `${templatesLocalBaseUrl}/templates/unittest/postgresql-dc-unittest.yaml`,
        {
          param: {
            NAME: phases[phase].name,
            SUFFIX: phases[phase].suffix,
    ...
    objects = objects.concat(
      oc.processDeploymentTemplate(
        `${templatesLocalBaseUrl}/templates/unittest/backend-dc-unittest.yaml`,
        {
          param: {
            NAME: phases[phase].name,
            SUFFIX: phases[phase].suffix,
