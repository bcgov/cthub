...
const phases = {
  ...
  dev: {namespace:'30b186-dev', transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        metabaseCpuRequest: '300m', metabaseCpuLimit: '500m', metabaseMemoryRequest: '500Mi', metabaseMemoryLimit: '2Gi',
  ...
  test: {namespace:'30b186-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        metabaseCpuRequest: '200m', metabaseCpuLimit: '300m', metabaseMemoryRequest: '500M', metabaseMemoryLimit: '2G',
        ...
        patroniCpuRequest: '500m', patroniCpuLimit: '1000m', patroniMemoryRequest: '500Mi', patroniMemoryLimit: '1Gi', patroniPvcSize: '5Gi', patroniReplica: 2, storageClass: 'netapp-block-standard', ocpName: `${ocpName}`},
  ...
  prod: {namespace:'30b186-prod', name: `${name}`, ssoSuffix:'', 
        ...
        metabaseCpuRequest: '500Mi', metabaseCpuLimit: '1000Mi', metabaseMemoryRequest: '500Mi', metabaseMemoryLimit: '2Gi',
