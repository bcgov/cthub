...
const phases = {
  ...
  test: {namespace:'30b186-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        metabaseCpuRequest: '200m', metabaseCpuLimit: '300m', metabaseMemoryRequest: '500M', metabaseMemoryLimit: '2Gi', metabaseReplicas: 1,
  ...
  prod: {namespace:'30b186-prod', name: `${name}`, ssoSuffix:'', 
        ...
        metabaseCpuRequest: '200m', metabaseCpuLimit: '400m', metabaseMemoryRequest: '750Mi', metabaseMemoryLimit: '2Gi', metabaseReplicas: 1,
