...
const phases = {
  ...
  dev: {namespace:'30b186-dev', transient:true, name: `${name}`, ssoSuffix:'-dev', 
        ...
        minioCpuRequest: '30m', minioCpuLimit: '100m', minioMemoryRequest: '150Mi', minioMemoryLimit: '300Mi', minioPvcSize: '3Gi', minioBucketName: 'cthubdv',
  ...
  test: {namespace:'30b186-test', name: `${name}`, ssoSuffix:'-test', 
        ...
        minioCpuRequest: '30m', minioCpuLimit: '100m', minioMemoryRequest: '150Mi', minioMemoryLimit: '300Mi', minioPvcSize: '3G', minioBucketName: 'cthubts',
  ...
  prod: {namespace:'30b186-prod', name: `${name}`, ssoSuffix:'', 
        ...
        minioCpuRequest: '30m', minioCpuLimit: '100m', minioMemoryRequest: '150Mi', minioMemoryLimit: '300Mi', minioPvcSize: '3G', minioBucketName: 'cthubpr',
